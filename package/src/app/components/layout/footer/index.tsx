...
const Footer = () => {
    ...
    const socials = [
        { name: 'Facebook', href: 'https://www.facebook.com/groups/1455118361753321/', icon: 'https://res.cloudinary.com/dlndnmuq1/image/upload/f_webp/v1768883527/creditor-website-assets/images/footer/facebook.webp' },
        { name: 'X', href: 'https://x.com/CreditorAcademy', icon: 'https://res.cloudinary.com/dlndnmuq1/image/upload/f_webp/v1768883533/creditor-website-assets/images/footer/twitter.webp' },
        { name: 'YouTube', href: 'https://www.youtube.com/@creditoracademy', icon: 'https://res.cloudinary.com/dlndnmuq1/image/upload/f_webp/v1768883538/creditor-website-assets/images/footer/youtube.webp' },
        { name: 'Rumble', href: 'https://rumble.com/user/CreditorAcademy', icon: 'https://res.cloudinary.com/dlndnmuq1/image/upload/f_webp/v1768883531/creditor-website-assets/images/footer/rumble.webp' },
        { name: 'TikTok', href: 'https://www.tiktok.com/@creditoracademy', icon: 'https://res.cloudinary.com/dlndnmuq1/image/upload/f_webp/v1768883532/creditor-website-assets/images/footer/tiktok.webp' },
    ];
    useEffect(() => {
