            ...
            <div className="flex items-center gap-2 sm:gap-3">
              <Link
                ...
                className={`flex justify-center items-center gap-2 text-sm sm:text-base font-bold rounded-full py-1.5 px-4 transition-colors
                  ${sticky
                    ? "bg-yellow-400 text-secondary hover:bg-secondary hover:text-white dark:bg-white dark:text-secondary dark:hover:bg-secondary dark:hover:text-white"
                    : "bg-yellow-400 text-slate-800 hover:bg-blue-700"}
                `}
              >
                Sign Up
              </Link>
