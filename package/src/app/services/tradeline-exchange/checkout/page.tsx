...
export default function CheckoutPage() {
  ...
  useEffect(() => {
    if (typeof window !== "undefined") {
      ...
      if (!storedUser) {
        router.push("https://lmsathena.com/login?redirect=/services/tradeline-exchange/checkout");
        return;
      }
      
      if (!agreementSigned) {
        router.push("/services/tradeline-exchange/user-agreement");
        return;
      }
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-slate-50 px-4 pt-24">
        <div className="text-center max-w-md">
          ...
          <button
            onClick={() => router.push("/services/tradeline-exchange/cart")}
