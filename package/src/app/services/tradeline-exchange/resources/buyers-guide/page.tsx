...
<div className="mt-2 h-1 w-20 rounded-full bg-sky-400"></div>
        ...
        <section className="bg-slate-50 rounded-md p-8">
          ...
          <div className="mt-6 flex flex-wrap gap-4">
            <a href="/services/tradeline-exchange/buy-tradelines" className="px-6 py-3 bg-[#0b5fa8] text-white rounded-md font-semibold">Shop Tradelines</a>
            {/* <a href="/services/tradeline-exchange/resources#buyers-guide" className="px-6 py-3 border border-slate-200 rounded-md">Read Buyer’s Guide</a> */}
            <a href="/services/tradeline-exchange/contact" className="px-6 py-3 border border-slate-200 rounded-md">Contact Sales</a>
          </div>
        </section>
      </main>
