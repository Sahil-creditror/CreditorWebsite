      ...
      <div id="content-block" className="max-w-7xl mx-auto px-6 space-y-16 py-12">
        ...
        <section className="w-full flex flex-col lg:flex-row items-center justify-between gap-4 py-8">
          ...
          <div className="flex gap-4">
            <a href="/services/tradeline-exchange/buy-tradelines" className="px-6 py-3 bg-[#0b5fa8] text-white rounded-md font-semibold shadow">Shop Tradelines</a>
            <a href="/services/tradeline-exchange/contact" className="px-6 py-3 border border-slate-200 rounded-md text-slate-700">Contact Sales</a>
          </div>
        </section>
      </div>
    </main>
