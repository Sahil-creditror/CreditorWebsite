...
export default function Navbar() {
  ...
  useEffect(() => {
    if (typeof window !== "undefined") {
      const updateCartCount = () => {
        try {
          const { cartStore } = require("@/app/services/tradeline-exchange/lib/cart");
  ...
  /* ---------------- PRIMARY LINKS ---------------- */
  const links = [
    { name: "HOME", path: "/services/tradeline-exchange" },
    { name: "BUY TRADELINES", path: "/services/tradeline-exchange/buy-tradelines" },
    { name: "SELL TRADELINES", path: "/services/tradeline-exchange/sell-tradelines" },
    // { name: "BROKERS", path: "/services/tradeline-exchange/brokers" },
    { name: "ABOUT", path: "/services/tradeline-exchange/about" },
    { name: "CONTACT", path: "/services/tradeline-exchange/contact" },
    { name: "MY ACCOUNT", path: "/services/tradeline-exchange/my-account" },
  ];
  ...
  const resourceItems = [
    {
      ...
      href: "/services/tradeline-exchange/resources/knowledge",
      icon: <BookOpen className="w-4 h-4" />,
    },
    {
      label: "What Is a Tradeline?",
      href: "/services/tradeline-exchange/resources/what-is-tradeline",
      icon: <FileText className="w-4 h-4" />,
    },
    {
      label: "Buyer’s Guide",
      href: "/services/tradeline-exchange/resources/buyers-guide",
      icon: <FileText className="w-4 h-4" />,
    },
    {
      label: "How to Order",
      href: "/services/tradeline-exchange/resources/how-to-order",
      icon: <PenTool className="w-4 h-4" />,
    },
    {
      label: "Calculator",
      href: "/services/tradeline-exchange/resources/calculator",
      icon: <Calculator className="w-4 h-4" />,
    },
    {
      label: "FAQs",
      href: "/services/tradeline-exchange/resources/faqs",
      icon: <FileText className="w-4 h-4" />,
    },
    {
      label: "Guarantee",
      href: "/services/tradeline-exchange/resources/guarantee",
      icon: <ShieldCheck className="w-4 h-4" />,
    },
    {
      label: "Report an Issue",
      href: "/services/tradeline-exchange/resources/report-non-posting",
    ...
    >
      <div className="max-w-7xl mx-auto px-4 py-3 flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          ...
          <Link href="/services/tradeline-exchange">
        ...
        <nav className="hidden lg:flex items-center gap-1 text-white text-[13px] font-semibold">
          ...
          {/* CART ICON */}
          <Link
            href="/services/tradeline-exchange/cart"
