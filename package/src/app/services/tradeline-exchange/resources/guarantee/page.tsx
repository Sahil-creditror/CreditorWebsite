          ...
          <div className="grid lg:grid-cols-2 gap-8 items-center">
            <div>
              ...
              <div className="mt-6 flex gap-3">
                ...
                <a href="/services/tradeline-exchange/contact" className="px-5 py-3 border border-white/20 rounded-full">Contact Support</a>
              </div>
            </div>
      ...
      <main id="guarantees" className="max-w-5xl mx-auto -mt-12 px-6 pb-20 space-y-10">
        ...
        <section className="bg-white rounded-2xl p-8 shadow-lg border border-blue-100 text-center">
          ...
          <div className="mt-6 flex items-center justify-center gap-4">
            <a href="/services/tradeline-exchange/contact" className="px-6 py-3 bg-[#0b5fa8] text-white rounded-md font-semibold">Contact Support</a>
            <a href="/services/tradeline-exchange/buy-tradelines" className="px-6 py-3 border border-slate-200 rounded-md">View Tradeline List</a>
          </div>
        </section>
      </main>
