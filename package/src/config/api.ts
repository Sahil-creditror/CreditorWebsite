...
export const API_CONFIG = {
  ...
  BASE_URL: process.env.NEXT_PUBLIC_API_BASE_URL || 'https://api.lmsathena.com/api',
 ...
 */
export const DEFAULT_WEBINAR_ID = process.env.NEXT_PUBLIC_WEBINAR_ID || '87368197441';
