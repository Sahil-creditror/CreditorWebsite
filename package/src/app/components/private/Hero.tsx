...
export default function Hero() {
  ...
  const features = [
    { icon: '💳', text: 'Build Business Credit' },
    { icon: '📈', text: 'Improve Credit Score' },
    { icon: '🏦', text: 'Access Funding' },
    { icon: '💼', text: 'Protect Personal Assets' }
  ];
    ...
    >
      ...
      <div className="flex flex-wrap gap-10 items-center relative z-10">
        ...
        <div className="flex-1 min-w-[18rem] p-5 relative z-10">
          ...
          >
            Unlock the power of business credit to grow your enterprise while protecting your personal assets. This course provides a step-by-step guide to building a strong business credit profile.
          </motion.p>
