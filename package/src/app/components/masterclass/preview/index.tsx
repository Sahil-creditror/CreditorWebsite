  ...
  return (
    <>
      ...
      <section className={`w-full ${sectionSpacing} relative overflow-hidden `}>
        ...
        <div
          aria-hidden
          className="pointer-events-none absolute inset-0 bg-gradient-to-tr from-sky-100/50 via-white/40 to-blue-100/50 dark:from-slate-900/75 dark:via-slate-900/65 dark:to-slate-900/80"
        />
        ...
        <div className="relative z-10 container mx-auto px-4 my-8 lg:my-15 max-w-7xl">
          ...
          <div className="grid lg:grid-cols-12 gap-6 lg:gap-8 items-start mb-6 lg:mb-8">
            ...
            <div className="lg:col-span-6 w-full relative">
              ...
              <div className="hidden sm:block absolute left-[27px] sm:left-[31px] top-8 bottom-0 w-[2px] sm:w-[3px] bg-gradient-to-b from-sky-400 via-blue-500 to-indigo-500 rounded-full opacity-40" aria-hidden />
              <div className="hidden sm:block absolute left-[27px] sm:left-[31px] top-8 bottom-0 w-[2px] sm:w-[3px] bg-gradient-to-b from-sky-400 via-blue-500 to-indigo-500 rounded-full blur-sm" aria-hidden />
                ...
                <div className="relative flex gap-3 sm:gap-5 group">
                  <div className="shrink-0">
                    <div className="relative">
                      ...
                      <div className="relative size-14 sm:size-16 rounded-2xl sm:rounded-3xl bg-gradient-to-br vom-blue-500 via-indigo-500 to-indigo-600 text-white shadow-xl shadow-indigo-500/40 grid place-items-center ring-2 ring-white/50 dark:ring-slate-700/50 transition-transform duration-300 group-hover:scale-110">
          ...
          <div className="w-full relative">
            ...
            <div className="hidden lg:block absolute left-[31px] -top-8 h-8 w-[3px] bg-gradient-to-b from-indigo-500 to-purple-600 opacity-40" aria-hidden />
            ...
            <div className="relative flex gap-3 sm:gap-5 group w-full">
              <div className="shrink-0">
                <div className="relative">
                  ...
                  <div className="relative size-14 sm:size-16 rounded-2xl sm:rounded-3xl bg-gradient-to-br from-indigo-500 via-purple-500 to-purple-600 text-white shadow-xl shadow-purple-500/40 grid place-items-center ring-2 ring-white/50 dark:ring-slate-700/50 transition-transform duration-300 group-hover:scale-105">
