                        ...
                        <div className="grid md:grid-cols-2 xl:grid-cols-4 gap-7">
                            ...
                            <div className="bg-primary p-4 lg:p-7 flex flex-col gap-32 rounded-xl transition-all duration-400 ease-in-out 
                                ...
                                <div className="flex items-center gap-4">
                                    <Image src={"https://res.cloudinary.com/dlndnmuq1/image/upload/v1768883927/creditor-website-assets/images/testimonial/testimonial_1.png"} alt="Image" width={60} height={60} className="rounded-full" />
                                    <div>
                            ...
                            <div className="xl:col-span-2 bg-secondary dark:bg-lightgray/10 p-4 lg:p-7 flex flex-col justify-between gap-14 rounded-xl transition-all duration-400 ease-in-out
                                ...
                                <div className="flex items-center justify-between">
                                    <div className="flex items-center gap-4">
                                        <Image src={"https://res.cloudinary.com/dlndnmuq1/image/upload/v1768883930/creditor-website-assets/images/testimonial/testimonial_2.png"} alt="Image" width={60} height={60} className="rounded-full" />
                                        <div>
                            ...
                            <div className="bg-white dark:bg-black/20 p-4 lg:p-7 flex flex-col justify-between gap-32 rounded-xl transition-all duration-400 ease-in-out
                                ...
                                <div className="flex items-center gap-4">
                                    <Image src={"https://res.cloudinary.com/dlndnmuq1/image/upload/v1768883932/creditor-website-assets/images/testimonial/testimonial_3.png"} alt="Image" width={60} height={60} className="rounded-full" />
                                    <div>
