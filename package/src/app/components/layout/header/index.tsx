        ...
        <nav className={`${sticky ? "h-16" : "h-20"} flex items-center justify-between`}>
          ...
          <div className="hidden lg:flex items-center gap-1">
            ...
            <div className="relative group">
              ...
              <div className="absolute top-full left-0 mt-2 w-60 bg-white border border-slate-100 rounded-2xl shadow-xl opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 p-2 backdrop-blur-xl">
                {[
                  ...
                  <Link
                    key={title}
                    href={url}
                    className="block px-4 py-3 rounded-xl text-slate-700 text-sm hover:bg-slate-50 hover:text-indigo-600 transition-all"
                  >
                    {title}
                  </Link>
                ))}
          ...
          <div className="flex items-center gap-3">
            ...
            <Link
              ...
              className="hidden md:flex px-6 py-2.5 rounded-xl bg-indigo-600 text-white font-bold text-sm hover:bg-indigo-500 transition-all duration-200 shadow-lg shadow-indigo-600/10 active:scale-[0.98]"
            >
              Sign In
            </Link>
