  ...
  return (
    <section style={{ fontFamily: 'Poppins, sans-serif', overflow: 'hidden', backgroundColor: '#f8fafc' }}>
      ...
      <motion.div
        ...
        style={{
          position: 'relative',
          background: `linear-gradient(rgba(15, 23, 42, 0.9), rgba(15, 23, 42, 0.95)), url('https://res.cloudinary.com/dlndnmuq1/image/upload/f_webp/v1768883604/creditor-website-assets/images/home/game/game_banner.webp') center center / cover no-repeat`,
